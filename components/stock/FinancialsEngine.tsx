      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-card border border-border/40 rounded-xl p-4 shadow-sm h-[320px] flex flex-col group relative">
          ...
          <div className="h-full w-full -m-4 p-4">
            {ratioTab === "ROIC" && <DecisionChart title={t('charts.roic')} data={chartData} type="COMPOSED" config={{ isPercentage: true, inverseColors: true, dataKeys: [{ key: 'roic', color: '#3b82f6', type: 'bar' }], referenceLine: { y: 0.15, color: '#10b981', label: '15%' } }} />}
