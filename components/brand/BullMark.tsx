...
export function BullMark({
  ...
  return (
    ...
    >
      ...
      {/* Head + eyes (eyes punched out via evenodd) */}
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M24 21C18 23 17 29 20 34C22 39 26 43 30 44.5C31.5 45.2 32.5 45.2 34 44.5C38 43 42 39 44 34C47 29 46 23 40 21C35 19 29 19 24 21ZM24.3 30.6a1.8 1.8 0 1 0 3.6 0a1.8 1.8 0 1 0 -3.6 0ZM36.1 30.6a1.8 1.8 0 1 0 3.6 0a1.8 1.8 0 1 0 -3.6 0Z"
      />

      {/* Rook / chess-piece pedestal */}
      <rect x="28" y="45.5" width="8" height="2.6" rx="1.2" />
      <rect x="24" y="49" width="16" height="3" rx="1.5" />
      <rect x="20" y="53" width="24" height="3.6" rx="1.8" />
    </svg>
  );
}
